...
* component[systolicBloodPressure].code.coding[loinc] = $loinc#8480-6 "Systolic blood pressure"
* component[systolicBloodPressure].code.coding[+] = $loinc#76215-3 "Invasive Systolic blood pressure"
* component[systolicBloodPressure].code.coding[snomed] = $sct#271649006 "Systolic blood pressure"
* component[systolicBloodPressure].code.coding[+] = $sct#251071003 "Invasive systolic arterial pressure (observable entity)"
...
* component[diastolicBloodPressure].code.coding[loinc] = $loinc#8462-4 "Diastolic blood pressure"
* component[diastolicBloodPressure].code.coding[+] = $loinc#76213-8 "Invasive Diastolic blood pressure"
* component[diastolicBloodPressure].code.coding[snomed] = $sct#271650006 "Diastolic blood pressure (observable entity)"
* component[diastolicBloodPressure].code.coding[+] = $sct#251073000 "Invasive diastolic arterial pressure (observable entity)"
