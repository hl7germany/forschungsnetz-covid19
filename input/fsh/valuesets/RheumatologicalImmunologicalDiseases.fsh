...
* $sct#105969002 "Disorder of connective tissue (disorder)"
* $sct#31996006 "Vasculitis (disorder)"
* $sct#36138009 "Congenital immunodeficiency disease (disorder)"
* $sct#396332003+414029004 "Rheumatism (disorder) + Disorder of immune function (disorder)"
* include codes from system $sct where concept is-a #128139000
* include codes from system $sct where concept is-a #414029004
* include codes from system $sct where concept is-a #81573002
* include codes from system $sct where concept is-a #396332003